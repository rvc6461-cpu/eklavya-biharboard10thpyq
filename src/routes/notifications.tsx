...
function NotificationsPage() {
  ...
  async function toggle(key: keyof NotificationPreference) { const next = !prefs[key]; setPrefs({ ...prefs, [key]: next }); setSaving(key); try { await saveNotificationPreference(user.id, { [key]: next }); } finally { setSaving(null); } }
